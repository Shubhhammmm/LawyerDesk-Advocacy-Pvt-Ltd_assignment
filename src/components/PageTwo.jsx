      ...
      <div className="flex  pt-4 gap-x-4">
        ...
        >
          <div className="flex items-center gap-2">
            <ChevronLeftIcon className="size-6 h-8 w-8 px-1 rounded-full bg-gray-100 " />
            <button
              onClick={handleBackToHome}
              className="px-16 py-2 rounded-lg text-xs font-bold text-white bg-gradient-to-r to-[#025BD4] from-blue-500 hover:from-pink-500 hover:to-yellow-500"
            >
              Back to home
            </button>
          </div>
        ...
        <div className="bg-white rounded-md" style={{ width: "60vw" }}>
          <div role="tablist" className="flex">
            <div
              role="tab"
              className={`tab ${
                activeTab === 1
                  ? "bg-blue-600 text-white tab-active rounded-tl-lg rounded-tr-lg w-full"
                  : "border-2 border-b-0 rounded-tl-lg rounded-tr-lg w-full"
              }`}
              onClick={() => toggleTab(1)}
            >
              Case Desc
            ...
            <div
              ...
              className={`tab ${
                activeTab === 5
                  ? "bg-blue-600 tab text-white tab-active rounded-tl-lg rounded-tr-lg w-full"
                  : "border-2 border-b-0 rounded-tl-lg rounded-tr-lg w-full"
              }`}
              onClick={() => toggleTab(5)}
            >
